...
<div class="card">
    ...
    <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
        <span class="h5 m-0">Asignación de Tareas</span>
        ...
        <div class="d-flex flex-wrap gap-2">
            ...
            <button class="btn btn-outline-secondary btn-sm" type="button" data-toggle="collapse" data-target="#filtrosCollapse">
            ...
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ ucfirst(str_replace('_', ' ', $taskAssignment->status)) }}</td>
        ...
        <form id="statusForm" method="POST" action="">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Motivo de la decisión</h5>
