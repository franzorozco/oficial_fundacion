    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email"
                class="block mt-1 w-full bg-transparent border-white border-opacity-40 text-white placeholder-white focus:border-[#db7fb5] focus:ring-[#cf1d86] rounded-md shadow-sm"
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center text-white cursor-pointer">
                ...
                <input 
                    ...
                    class="w-4 h-4 cursor-pointer rounded border-gray-300 bg-white text-[#cf1d86] focus:ring-[#cf1d86]"
                >
