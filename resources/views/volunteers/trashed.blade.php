    ...
    <div class="card">
        <div class="card-header">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="{{ route('volunteers.index') }}" class="btn btn-primary btn-sm">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>{{ $user->address }}</td>
                                <td>
                                    <form action="{{ route('volunteers.restore', $user->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <form action="{{ route('volunteers.forceDelete', $user->id) }}" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
