...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('task_assignments', function (Blueprint $table) {
            $table->foreign(['donation_request_id'], 'fk_task_assignments_donation_request')->references(['id'])->on('donation_requests')->onUpdate('restrict')->onDelete('cascade');
    ...
    {
        Schema::table('task_assignments', function (Blueprint $table) {
            $table->dropForeign('fk_task_assignments_donation_request');
