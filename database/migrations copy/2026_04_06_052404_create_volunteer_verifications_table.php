...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('volunteer_verifications', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('user_resp_id')->nullable()->index('user_resp_id');
            $table->string('document_type', 100)->nullable();
            $table->string('document_url')->nullable();
            $table->text('name_document')->nullable();
            $table->enum('status', ['pendiente', 'aprobado', 'rechazado', 'reconsideracion'])->nullable()->default('pendiente');
