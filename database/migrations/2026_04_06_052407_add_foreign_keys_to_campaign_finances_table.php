...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('campaign_finances', function (Blueprint $table) {
            ...
            $table->foreign(['financial_account_id'], 'fk_related_financial_account')->references(['id'])->on('financial_accounts')->onUpdate('restrict')->onDelete('set null');
        });
    }
    ...
    public function down(): void
    {
        Schema::table('campaign_finances', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_related_financial_account');
        });
    }
};
