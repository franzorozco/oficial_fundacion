...
Permission::create(['name' => 'volunteer.dashboard.view', 'description' => 'Ver panel del voluntario'])->syncRoles([$role2]);
Permission::create(['name' => 'volunteer.tasks.view', 'description' => 'Ver tareas disponibles'])->syncRoles([$role2]);
Permission::create(['name' => 'volunteer.tasks.claim', 'description' => 'Reclamar tarea disponible'])->syncRoles([$role2]);
Permission::create(['name' => 'volunteer.feedback.submit', 'description' => 'Enviar retroalimentación de actividad'])->syncRoles([$role2]);
Permission::create(['name' => 'volunteer.activities.view', 'description' => 'Ver historial de actividades'])->syncRoles([$role2]);
Permission::create(['name' => 'volunteer.activities.submit', 'description' => 'Registrar actividad realizada'])->syncRoles([$role2]);
